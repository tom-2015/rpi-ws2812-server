...
2D/text_input.o: 2D/text_input.c 2D/text_input.h ws2812svr.h sockets.h
	$(CC) -c $< -o $@
...
audio/record.o: audio/record.c audio/record.h ws2812svr.h sockets.h pipe.h
	$(CC) -c $< -o $@

audio/vu_meter.o: audio/vu_meter.c audio/vu_meter.h ws2812svr.h
	$(CC) -c $< -o $@

audio/wave.o: audio/wave.c audio/wave.h ws2812svr.h
	$(CC) -c $< -o $@
...
master_slave.o: master_slave.c master_slave.h ws2812svr.h sockets.h ws2811.h sk9822.h pipe.h
	$(CC) -c $< -o $@
